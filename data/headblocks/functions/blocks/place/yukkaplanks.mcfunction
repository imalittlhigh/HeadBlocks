...
execute align xyz run summon item_display ~-0.0002 ~ ~ {Tags:["headblocks","headblocks.item_display","headblocks.light.west"],item:{id:"minecraft:player_head",Count:1,tag:{SkullOwner:{Id:[I;0,0,0,0],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvM2E2MWIzYjE1ZWZmMzA2ZmRlNmI0YTg4M2MwMjY3ZTZiM2NkNGQ1OThiMGY3ZmJkYmVlMjJiNmUyYmVmMDNhYiJ9fX0="}]}}}},transformation:[2.01f,0.000f,0.000f,0.50f,0.000f,2.01f,0.000f,1.0025f,0.0000f,0.000f,2.01f,0.50f,0.0000f,0.0000f,0.0000f,1.000f]}
