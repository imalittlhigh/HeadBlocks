...
execute if score %debug headblocks.dummy matches 1 run tellraw @a [{"text": "Block at [","color": "gray"},{"nbt":"Pos[0]","entity":"@s"},{"text": ","},{"nbt":"Pos[1]","entity":"@s"},{"text": ","},{"nbt":"Pos[2]","entity":"@s"},{"text": "] set light source to East"}]
